    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods', models.ForeignKey(verbose_name='商品SPU', to='apps.goods.Goods')),
            ],
            options={
                'verbose_name': '商品',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sku', models.ForeignKey(verbose_name='商品', to='apps.goods.GoodsSKU')),
            ],
            options={
                'verbose_name': '首页轮播商品',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('index', models.SmallIntegerField(verbose_name='展示顺序', default=0)),
                ('sku', models.ForeignKey(verbose_name='商品SKU', to='apps.goods.GoodsSKU')),
                ('type', models.ForeignKey(verbose_name='商品类型', to='apps.goods.GoodsType')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='goodssku',
            name='type',
            field=models.ForeignKey(verbose_name='商品种类', to='apps.goods.GoodsType'),
        ),
        migrations.AddField(
            model_name='goodsimage',
            name='sku',
            field=models.ForeignKey(verbose_name='商品', to='apps.goods.GoodsSKU'),
        ),
    ]
